...
public interface FileInfoMapper<T, P> extends BaseMapper<T, P> {
    ...
    void delFileBatch(@Param("userId") String userId, @Param("filePidList") List<String> filePidList, @Param("filePidList") List<String> fileidList, @Param("oldDelFlag") Integer oldDelFlag);
